...
const Modal = ({ children }: Props) => {
  ...
  return (
    <div className='flex flex-col max-w-[824px] max-h-[90vh] h-fit pt-[42px] bg-black border-l border-white border-b absolute top-0 right-0' onClick={(e) => e.stopPropagation()}>
      ...
      <div className='px-8 flex flex-col overflow-y-scroll scrollbar'>
        {/* Header Cart */}
      ...
      {/* Footer Cart */}
      <div className=' flex items-center justify-between border-t px-8 h-[88px] mt-auto'>
        <span className='block font-bold text-[35px]'>TOTAL: ${totalPrice?.toFixed(2)}</span>
        <div className='flex'>
